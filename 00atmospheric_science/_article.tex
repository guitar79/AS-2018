...
%	SECTION 1
%----------------------------------------------------------------------------------------
\include{01_effective_temperature}	
\include{02_escape_velocity}	
\include{03_atmospheric_movement}	
\include{04_hydrostatic_equation_of_atmosphere}	
\include{05_Thermodynamics_of_atmosphere}	
